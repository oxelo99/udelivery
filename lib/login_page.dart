...
class _LoginPageState extends State<LoginPage> {
  ...
  Future signIn() async {
    ...
    await FirebaseAuth.instance.signInWithEmailAndPassword(
        ...
        password: _passwordcontroller.text.trim());}on FirebaseAuthException catch (e) {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(                                          //se creaza o margine interioara astfel incat field-ul sa dea impresia
                  padding: const EdgeInsets.all(15.0),            //unei margini si sa nu ocupe toata latimea coloanei(ecranului)
                  child: TextField(
                ...
                Text(                                                             //furnizeaza utilizatorului posibilele erori pe care le
